...
plt.xlabel(r'Permeability calculated using Kozeny-Carman equation $\frac{k_{Carmen}}{k_{Carmen,0}}$',fontsize = 'large')
plt.ylabel(r'Measured Permeability $\frac{k}{k_0}$',fontsize = 'large')
